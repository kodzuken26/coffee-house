...
SECRET_KEY = 'django-insecure-ux2yotsiaoy5-75s0!(zfu^y_4=!mjhmxzh*4%a9lyf6pjz!1a'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Ваш Проект API',
    'DESCRIPTION': 'Документация по всем конечным точкам',
    'VERSION': '1.0.0',
    # Другие настройки (например, для аутентификации)
